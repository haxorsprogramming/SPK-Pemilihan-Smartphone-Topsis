...
<script src="<?=STYLEBASE."admin/"; ?>asset/vendors/perfect-scrollbar/js/perfect-scrollbar.min.js"></script>
<script src="<?=STYLEBASE."admin/"; ?>asset/vendors/@coreui/coreui/js/coreui.min.js"></script>
