...
<link rel="stylesheet" type="text/css" href="<?=STYLEBASE."home/"; ?>plugins/OwlCarousel2-2.2.1/owl.theme.default.css">
...
<div class="super_container" style="font-family: 'Noto Sans JP', sans-serif;">
					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<nav class="main_nav_contaner">
								<ul class="main_nav">
									<li class="active"><a href="<?=HOMEBASE; ?>home"  style="color:aliceblue;">Beranda</a></li>
	...
	<div class="home">		
		<div class="section_background" data-parallax="scroll" data-image-src="<?=STYLEBASE."home/"; ?>images/courses_background.jpg" data-speed="0.8"></div>
	</div>
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
                        ...
                        <h2 class="section_title" style="font-family: 'Noto Sans JP', sans-serif;">Pemilihan Smartphone</h2>
	...
	<!-- Footer -->
	<footer>
	<div style='text-align:center;'>Develop By Agung Hamdika Surya - Program Studi Ilmu Komputer, Fakultas Sains dan Teknologi, Universitas Islam Negeri Sumatera Utara</div> 
	</footer>
</div>
